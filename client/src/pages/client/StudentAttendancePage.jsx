...
const StudentAttendancePage = () => {
  ...
  return (
    <>
      <div className='grid grid-cols-1 gap-8 p-6 max-w-6xl mx-auto lg:grid-cols-[1.4fr_1fr]'>
        ...
        <div className='bg-white rounded-lg shadow-lg p-8'>
          <h2 className='text-2xl font-bold mb-6 text-gray-800'>Attendance by Admin</h2>
          <div className='bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-8 flex flex-col items-center justify-center min-h-80'>
            ...
            <p className='text-gray-700 text-lg font-semibold mb-2 text-center'>Your Unique QR Code</p>
            <p className='text-gray-600 text-center mb-4'>Admin can scan this code for marking attendance</p>
          </div>
